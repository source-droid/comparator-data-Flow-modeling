...
HD_PWD='C:/Users/031-17-0027/Desktop/Encoder/comparator/comparator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comparator_4bit.vds -m64 -mode batch -messageDb vivado.pb -notrace -source comparator_4bit.tcl
